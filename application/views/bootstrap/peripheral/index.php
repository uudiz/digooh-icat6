<div class="container-fluid">
      ...
      <?php if ($auth >= $ADMIN) : ?>
        <div class="col-auto ms-auto">
          <div class="btn-list">
            ...
            <a href="/Peripheral_controller/edit" class=" btn btn-primary">
  ...
  <div class="page-body">
    ...
    <div class="card-table table-responsive">
      <table id="table" class="table table-striped table-responsive" id="table" data-toggle="table" data-url="/Peripheral_controller/getTableData" data-sort-name="name" data-sort-order="asc" data-detail-view="true">
        <thead>
          <tr>
            ...
            <th data-field="baudrate" data-sortable="true"><?php echo lang('baudrate'); ?></th>
            <th data-field="parity" data-sortable="true" data-formatter="parityFormatter"><?php echo lang('parity'); ?></th>
            <th data-field="stop_bits" data-sortable="true"><?php echo lang('stop_bit'); ?></th>
            <th data-field="data_bits" data-sortable="true"><?php echo lang('data_bit'); ?></th>
...
<script>
  function nameFormatter(value, row, index) {
    ret = value;
    <?php if ($auth == 5) : ?>
      ret = `	<a href="/Peripheral_controller/edit?id=${row.id}" class="link-primary">
                   ${value}
                </a>`
    <?php endif ?>
    return ret;
  ...
  function operateFormatter(value, row) {
    return `<div class="btn-list flex-nowrap">
			...
			<a href="#" onClick="remove_resource('Peripheral_controller', ${row.id})" class="link-danger">
  ...
  function operateFormatter(value, row, index) {
    ...
    html += `
			<a href="#" onClick="remove_resource('Peripheral_controller', ${row.id})">
  ...
  $("#batch_delete").click(function() {
    ...
    if (selections.length) {
      ...
      remove_resource('Peripheral_controller', id);
    }
  });
  ...
  $('#table').on('expand-row.bs.table', function(e, index, row, $detail) {
    ...
    $.get(
      `/Peripheral_controller/detail?id=${row.id}`,
      function(data) {
        $detail.html(data);
      }
    );
