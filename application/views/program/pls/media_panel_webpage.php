...
<table class="table-list"  width="100%" >
	<tr>
		<th width="50" >
        	<input type="checkbox" name="checkAll" id="topCheckAll" onclick="interactionpls.checkAllMedia(this);">
		</th>
...
<p class="btn-center">
	<a class="btn-01" href="javascript:void(0);" onclick="interactionpls.saveAreaMedia(<?php echo $playlist_id;?>,<?php echo $area_id;?>,'<?php echo lang('warn.choose.empty.tip');?>',true, false);"><span><?php echo lang('button.ok');?></span></a>
