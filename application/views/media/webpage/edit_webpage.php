	...
	<table width="500" cellspacing="0" cellpadding="0" border="0" class="from-panel">
		<tbody>
			<tr>
				...
				<td>
					<input type="text" id="name" name="name" class="text ui-widget-content ui-corner-all" style="width:240px;" value="<?php echo $rss->name;?>"/>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<textarea name="descr" id="descr" class="ui-widget-content ui-corner-all" rows="2" style="width:240px;"><?php echo $rss->descr;?></textarea>
				</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" id="url" name="url" class="text ui-widget-content ui-corner-all" style="width:240px;" value="<?php echo $rss->url;?>"/>
				</td>
				<td>
					<div class="attention" id="errorName" style="display:none;">
