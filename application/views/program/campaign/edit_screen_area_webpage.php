...
<table id="mediaTable" class="from-panel" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		...
		<td><input type="checkbox" name="url_type" id="url_type" <?php if($media->url_type):?>checked="checked"<?php endif;?>/></td>
	</tr>
	 -->
	<tr id="updateFrequency" <?php if($media->url_type):?>style="display:none;"<?php endif;?>>
...
<script type="text/javascript">
	campagin.initEditMedia();
	campagin.initFormDate();
	/*	
	$(function() {
