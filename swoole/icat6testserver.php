...
require_once('swoole_config_test.php');
...
$server = new Swoole\Server('0.0.0.0', 4702, SWOOLE_PROCESS, SWOOLE_SOCK_TCP);

$server->addlistener("127.0.0.1", 4702, SWOOLE_SOCK_UDP); // UDP
...
$server->set([
    ...
    'log_file' => '/tmp/swooletest.' . date('Y-m-d') . '.log',
]);
