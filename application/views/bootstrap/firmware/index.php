<div class="container-fluid">
  ...
  <div class="page-body">
    ...
    <div class="card-table table-responsive">
      <table id="table" class="table table-striped table-responsive" id="table" data-toggle="table" data-url="/Firmware_controller/getTableData" data-sort-name="version" data-sort-order="desc" data-detail-view="true" data-detail-formatter="detailFormatter">
        <thead>
          <tr>
...
<script>
  function nameFormatter(value, row, index) {
    ret = value;
    <?php if ($auth == 10) : ?>
      ret = `	<a href="/firmware_controller/edit?id=${row.id}" class="link-primary">
                   ${value}
                </a>`
    <?php endif ?>
    return ret;
  ...
  function operateFormatter(value, row) {
    return `<div class="btn-list flex-nowrap">
			...
			<a href="#" onClick="remove_resource('firmware_controller', ${row.id})" class="link-danger">
  ...
  function operateFormatter(value, row, index) {
    ...
    <?php if ($auth == 10) : ?>
      html += `
			<a href="#" onClick="remove_resource('firmware_controller', ${row.id})">
