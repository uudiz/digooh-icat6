...
<table id="mediaTable" class="from-panel" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		...
		<td>
			<input type="text" name="updateF" id="updateF" value="00:10" style="width:150px;"/> &nbsp;<span class="example"><?php echo lang('fromat.hh.mm');?></span>
		</td>
	</tr>
	<!--
	<tr>
...
<p class="btn-center">
	...
	<a class="btn-01" href="javascript:void(0);" onclick="interactionpls.saveAreaMediaWebpage(<?php echo $playlist_id;?>, <?php echo $area_id;?>, <?php echo $media_type;?>);"><span><?php echo lang('button.save');?></span></a>
