	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="from-panel">
		<tbody>
			<tr>
				...
				<td>
					<select id="format" name="format" class="text ui-widget-content ui-corner-all" onchange="interaction.screen.changeWeatherFormat(this);" style="width: 150px;">
			...
			<tr>
				...
				<td>
					<select id="family" name="family" class="text ui-widget-content ui-corner-all" onchange="interaction.screen.changeDateFamily(this);" style="width: 150px;">
			...
			<tr>
				...
				<td>
					<select id="fontSize" name="fontSize" class="text ui-widget-content ui-corner-all" onchange="interaction.screen.changeDateFontSize(this);" style="width: 150px;">
...
<p class="btn-center">
	<a class="btn-01" href="javascript:void(0);" onclick="interaction.screen.setWeatherSetting('date');"><span><?php echo lang('button.save');?></span></a>
