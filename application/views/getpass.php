<html>
	<head>
		...
		<script>
			...
			function update(num) {
				 if(num == secs) {
				 document.getElementById("agree").value ="Try it again";
				 document.getElementById("agree").disabled=false;
				 }
				else {
				 printnr = secs-num;
				 document.getElementById("agree").value = "Please wait(" + printnr +")";
				 }
				}
		...
		<div id="container" style="position:relative;">
			<form action="/login/get_pwd" method="POST" onsubmit="return doValidation();"> 
				...
				<div style="margin-top:30px;">
					<p style=" font-family:Arial, Helvetica, sans-serif; font-size:22px;text-align:center;"><?php echo lang('forget_pwd_info2')?></p>
				...
				<div style="margin-top:30px;margin-left:80px;">
					...
					<p><input class="blue" type="submit" value="next" id="agree" name="agree" /></p>
			</form>
