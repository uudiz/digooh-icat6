<div class="clear"></div>
<h1 class="tit-01" style="position:relative;"><?php echo lang('player');?> (Online)
	<div class="filter" style="width:84%;">
		...
		<a href="javascript:void(0);" style="margin-left:20px; " class="btn-go" onclick="player.cplayerFilter();"><label><?php echo lang('filter');?></label></a>
	</div>
    <span></span>
</h1>
<div class="clear"></div>
	...
	<table class="table-list"  width="100%" >
        ...
        ?>
            ...
            echo $row->name;
			  ...
			  <?php endif;?>
				<td><?php if (!empty($row->company_name)) {
...
<div id="rotateConfirm" title="Confirm" style="display:none;">
	<p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 80px 0;"></span>test<?php echo lang('warn.screenshot');?></p>
</div>