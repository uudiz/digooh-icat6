...
<div class="tit-02" style="float:right;margin:0px 16px;padding-right:100px;">
	...
	<a href="javascript:void(0);" class="btn-go" style="margin-left:20px;" onclick="schedule.form.filterPlaylist(<?php echo $sch_type;?>);"><label><?php echo lang('filter');?></label></a>
</div>
<span></span></h1>
...
<p class="btn-center">
	<a href="javascript:void(0);" onclick="schedule.form.addPlaylist('<?php echo lang('warn.scheudle.playlist.empty');?>');return false;" class="btn-01"><span><?php echo lang('button.add');?></span></a>
