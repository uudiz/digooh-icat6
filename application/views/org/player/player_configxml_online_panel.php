...
<table class="table-list" width="100%">
        <tr>
            ...
            <th >
				<a href="javascript:void(0);" onclick="configxml.page(<?php echo $ptype;?>,<?php echo $curpage;?>,'name','<?php if($order_item == 'name' && $order == 'desc'):?>asc<?php else:?>desc<?php endif;?>', <?php echo $id;?>, <?php echo $pid;?>);" ><?php echo lang('player');?></a>
			...
			<th >
				<a href="javascript:void(0);" onclick="configxml.page(<?php echo $ptype;?>,<?php echo $curpage;?>,'sn','<?php if($order_item == 'sn' && $order == 'desc'):?>asc<?php else:?>desc<?php endif;?>', <?php echo $id;?>, <?php echo $pid;?>);" ><?php echo lang('sn');?></a>
