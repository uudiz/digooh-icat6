...
class Firmware extends MY_Model
{
    ...
    public function add_item($array)
    {
        ...
        if ($this->db->insert('cat_firmware', $array)) {
    ...
    public function update_item($array, $id)
    {
        ...
        $this->db->where('id', $id);
        if ($this->db->update('cat_firmware', $array)) {
            return true;
        } else {
            return false;
        }
    ...
    public function get_firmware_by_version($version)
    {
        $this->db->from('cat_firmware');
