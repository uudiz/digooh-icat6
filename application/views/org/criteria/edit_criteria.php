...
<table cellspacing="0" cellpadding="0" border="0" class="from-panel">
		<tbody>
			<tr>
				...
				<td>
					<input type="text" id="name" name="name" style="width:150px;" value="<?php echo $region->name;?>" />
				</td>
			...
			<tr>
				...
				<td>
					<textarea name="descr" id="descr" rows="3" style="width:150px;"><?php echo $region->descr;?></textarea>
				</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
