	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="from-panel">
		<tbody>
			<tr>
				...
				<td>
					<select id="format" name="format" class="text ui-widget-content ui-corner-all" onchange="template.screen.changeDateFormat(this);" style="width: 150px;">
			...
			<tr>
				...
				<td >
					<input type="checkbox" id="bold" name="bold"  onchange="template.screen.changeDateFontBold(this);"/>
				</td>
			</tr>
			<?php endif;?>
			<tr>
...
<p class="btn-center">
	<a class="btn-01" href="javascript:void(0);" onclick="template.screen.setDateSetting('date');"><span><?php echo lang('button.save');?></span></a>
