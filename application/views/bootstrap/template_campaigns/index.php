<div class="container-fluid">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-auto ms-auto">
        <div class="btn-list">
          ...
          <?php if ($auth >= 4 || ($this->config->item("new_campaign_user") && $auth == 1)) : ?>
            <a href="/playlist/edit" class=" btn btn-primary">
  ...
  <div class="page-body">
    ...
    <div class='table-responsive'>
      <table id='table' class="table table-striped table-responsive" id="table" data-toggle="table" data-url="/playlist/getTableData" data-sort-name="update_time" data-sort-order="desc">
        <thead>
          <tr>
            ...
            <th data-field="players_cnt" data-formatter="playerCountFormatter" data-width="60"><?php echo lang('device.count'); ?></th>
            <th data-field="published" data-sortable="true" data-formatter="publishedFormatter" data-width="60"> <?php echo lang('published'); ?></th>
            <th data-field="template_name" data-sortable="true" data-align="center"> <?php echo lang('template'); ?></th>
  ...
  <div class="modal modal-blur fade" id="refresh_confirm" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center py-4">
          ...
          <h3></h3>
          <div class="text-muted"><?php echo lang('campaign.refresh.msg') ?></div>
        </div>
        <div class="modal-footer">
          <div class="w-100">
            <div class="row">
              ...
              <div class="col"><a href="#" class="btn btn-danger w-100" data-bs-dismiss="modal" id="refresh">
...
<script>
  ...
  function nameFormatter(value, row, index) {
    ...
    ret = `	<a href="/playlist/edit?id=${row.id}" class="link-primary">
                   ${value}
                </a>`
    return ret;
  }
  ...
  function show_devices(id) {
    ...
    $.getJSON('/playlist/getAffectedPlayers', {
      id: id
    }, function(res) {
      ...
      $('#ex-cnt').html(" : " + p_count);
      $('#export_devices').attr('href', `/playlist/export_devices?id=${id}`);
    });
  ...
  function operateFormatter(value, row) {
    ...
    <?php if (($auth > 1 && $auth != 4) || ($this->config->item("new_campaign_user") && $auth == 1)) : ?>
      html += `<a href="#" onClick="remove_resource('playlist', ${row.id})" class="link-danger" title="<?php echo lang('delete') ?>">
        <i class="bi bi-x-square"></i>
			</a>`
    <?php endif ?>
    html += `<a href="#" onClick="show_devices('${row.id}')" class="link-primary" title="<?php echo lang('player') ?>">
        <i class="bi bi-display"></i></i>
			</a>
		</div>`;
    return html;
  };
  ...
  function refresh_all_campaigns() {
    ...
    $('#refresh_confirm').modal("show")
      .on('click', '#refresh', function(e) {
        showSpinner();
        $.get("/playlist/do_refresh_all_campaigns", function(data) {
          hideSpinner();
