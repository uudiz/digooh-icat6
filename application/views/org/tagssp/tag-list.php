<table class="table-list"  width="100%" border="0">
        ...
        ?>
            ...
            echo $row->descr;
			  ...
			  <td>
			  	<?php if ($auth > 1):?>
			  		<a href="/tagSSP/edit?id=<?php echo $row->id;?>&width=450&height=320"  class="thickbox" title="<?php echo lang('edit.tag');?>"><img id="edit_<?php echo $row->id;?>" src="/images/icons/24-edit.png"  title="<?php echo lang('edit');?>" /></a>
