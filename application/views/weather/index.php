<?php if(!$super):?>
<div class="add-panel">
	<a href="/weather/add?width=320&height=240" id="create" class="thickbox" title="<?php echo lang('template.new');?>"><?php echo lang('template.new');?></a>
</div>
<?php endif;?>
<div class="clear"></div>
<h1 class="tit-01">
	<?php echo lang('weather.template');?>
						              ...
						              <tr>
						                <td align="right">
						                	 <div class="operate">										
											 	...
											 	<?php if($auth > 1):?>
											 	<a href="javascript:void(0);" onclick="weather.index.remove(<?php echo $row->id;?>,'<?php echo lang('tip.remove.item');?>',false,<?php if($idx == 0 || $curpage == 1){echo $curpage;}elseif($curpage>1){echo $curpage-1;} ?>);"><img id="del_<?php echo $row->id;?>" src="/images/icons/24-del.png" title="<?php echo lang('delete');?>" /></a>
												<?php endif;?>
						                     </div>
						                </td>
						              </tr>
