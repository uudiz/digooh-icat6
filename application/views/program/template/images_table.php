<h2 class="tit-01"><?php echo lang('image');?>
	<div class="filter" >
		...
		<a href="javascript:void(0);" class="btn-go" style="margin-left:10px;" onclick="template.screen.imageFilter('<?php echo $type;?>');"><label><?php echo lang('filter');?></label></a>
	</div>
    <span></span>
</h2>
<?php if($total > 0):?>
			...
			<table width="180" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" class="content">
                	<div class="pic">
                		<a href="javascript:void(0);" onclick="template.screen.setImage(<?php echo $row->id.',\''.$type.'\'';?>)" >
...
<div class="page-panel-center">
    <ul class="pagination">
		...
		<?php if($curpage>1):?>
			<li><a href="javascript:void(0);" onclick="template.screen.imagePage(1,'<?php echo $type;?>');" ><?php echo lang('page.first');?></a></li>
			<li><a href="javascript:void(0);" onclick="template.screen.imagePage(<?php echo $curpage-1;?>,'<?php echo $type;?>');"><?php echo lang('page.prev');?></a></li>	
		<?php endif;?>
	    ...
	    <li <?php if($i == $curpage):?>class="active"<?php endif;?>>
	    	<?php if($i == $curpage):?>
				<?php echo $i;?>
			<?php else:?>
				<a href="javascript:void(0);" onclick="template.screen.imagePage(<?php echo $i;?>,'<?php echo $type;?>');"><?php echo $i;?></a>
			<?php endif;?>
		</li>
		<?php endfor;?>
		<?php if($curpage<$totalPage):?>
			<li><a href="javascript:void(0);" onclick="template.screen.imagePage(<?php echo $curpage+1;?>,'<?php echo $type;?>');"><?php echo lang('page.next');?></a></li>
			<li><a href="javascript:void(0);" onclick="template.screen.imagePage(<?php echo $totalPage;?>,'<?php echo $type;?>');"><?php echo lang('page.last');?></a></li>	
		<?php endif;?>
  	</ul>
</div>
<?php endif;?>
