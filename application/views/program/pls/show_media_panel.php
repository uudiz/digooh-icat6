...
<h2 class="tit-01">
	...
	<div class="filter" style="float:right;margin:0px 16px;padding-right:2px;">
		...
		<select id="filterFolder" name="filterFolder" style="width: 150px; margin:0px 4px;" onchange="interactionpls.addShowMediaFilter(<?php echo $playlist_id.','.$area_id.',\''.$bmp.'\','.$media_type.',1';?>);">
		...
		<a href="javascript:void(0);" class="btn-go" style="margin-left:20px;" onclick="interactionpls.addShowMediaFilter(<?php echo $playlist_id.','.$area_id.',\''.$bmp.'\','.$media_type.',1';?>);"><label><?php echo lang('filter');?></label></a>
	</div>
</h2>
...
<script>
	interactionpls.initShowMediaPanel();
</script>