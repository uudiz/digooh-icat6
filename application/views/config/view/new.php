...
<table cellspacing="0" cellpadding="0" border="0" class="from-panel">
		<tbody>
			...
			<tr>
				...
				<td>
					<input type="text" readonly="readonly" id="startTime" name="startTime" style="width:200px;" value="<?php echo $start_time;?>"/>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" readonly="readonly" id="endTime" name="endTime" style="width:200px;" value="<?php echo $end_time;?>" />
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" id="brightness" name="brightness" style="width:100px;" value="<?php echo $brightness;?>"/><?php echo lang('config.rang');?>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" id="saturation" name="saturation" style="width:100px;" value="<?php echo $saturation;?>" /><?php echo lang('config.rang');?>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" id="contrast" name="contrast" style="width:100px;" value="<?php echo $contrast;?>"/><?php echo lang('config.rang');?>
				</td>
				<td>
